...
中国 K12 全学段（小学/初中/高中）知识点及其关系图谱数据集，从 254 本真实教材中抽取构建。
...
| 初中 | 9,980 |
| 高中 | 7,439 |
| 关系总数 | 20,714（prerequisite / leads-to / related）|
| 覆盖教材 | 254 本 |
| 覆盖科目 | 17 个 |
...
```
knowledge_points.json   # 全量知识点（53MB）
kp_relations.json       # 全量关系（9.4MB）
meta.json               # 元信息
